...
.select__container.disabled .select:focus-visible {
...
.select__container .select:focus-visible {
...
.select__container .select .expand {
  display: flex;
...
.select__container .select .search__container input {
  width: 100%;
  border: none;
  border-radius: 0;
  font-style: inherit;
...
.select__container .select .search__container input:focus {
  outline: none;
...
.dropdown .items_container .item.hide {
  display: none;
}
.dropdown .items_container .item.preselected {
  background-color: color-mix(in srgb, var(--accent) 25%, transparent);
}
.dropdown .items_container .item.selected {
  background-color: color-mix(in srgb, var(--accent-400) 75%, transparent);
}
.dropdown .items_container .item.item__border {
  border-bottom: 1px solid var(--mono-100);
}
.dropdown .items_container .no_options_found {
